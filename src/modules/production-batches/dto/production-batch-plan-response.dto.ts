...
/**
 * Header PO + toàn bộ Part của BOM cho 1 stage (HAN|SON) - cho HAN_STAFF/SON_STAFF chọn part thật
 * để báo sản lượng mà không cần SKU:VIEW/PRODUCTION_ORDER:VIEW/BOM_REVISION:VIEW (chỉ cần biết
 * trước productionOrderId, xem PRODUCTION_ORDER:VIEW mới cấp cho 2 role này để list được
 * GET /production-orders). Cố ý KHÔNG có deadline - ProductionOrder không có cột này (deadline nằm
 * ở SalesOrder/ProductionInvoiceItem, HAN/SON không có quyền đọc).
 */
@Exclude()
